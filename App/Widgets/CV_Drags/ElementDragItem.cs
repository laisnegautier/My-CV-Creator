...
{
    public partial class ElementDragItem : UserControl
    {
        IElement Content { get; set; }

        public ElementDragItem(IElement content, string name, string description = "")
        {
            InitializeComponent();
            Content = content;
            ElementDragName.Text = name;
            ElemDragItemDescp.Text = description;
